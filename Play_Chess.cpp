    ...
    if (argc > 1) {
        for (int i = 1; i < argc; i++) {
            ...
            if (strcmp(argv[i], "/?") == 0 || strcmp(argv[i], "--help") == 0) {
                ...
                printf("--loadsave: Load the file from an automatically saved game.\n");
                printf("-> The next argument should be a valid file name. With no slashes or periods or invaid chars.\n");
                printf("->To save a game, type save\n");
                printf("->That will prompt you for a file name to open.\n");
